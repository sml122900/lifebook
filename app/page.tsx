...
export default async function Home({
  ...
  return (
    <main className="flex flex-1 flex-col items-center justify-center gap-8 px-6 py-16">
      {withdrawn && (
        <div className="max-w-md rounded-md border-2 border-emerald-200 bg-emerald-50 px-5 py-4 text-center text-lg text-ink">
      ...
      <Link
        href="/life-timeline"
        className="text-xl text-action underline underline-offset-4 hover:text-ink"
      >
        내 인생 연혁 보러 가기 →
      </Link>
    </main>
