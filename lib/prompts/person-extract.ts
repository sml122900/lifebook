...
성 바로 뒤에 직함이 붙은 호칭("김부장님", "이과장님", "박사장님", "최선생님")은
성과 직함을 쪼개지 마세요 — 그 분을 부르는 이름 자체이므로 "님"만 뗀 형태를
name 에 통째로 넣고("김부장"), relation 은 직함("부장")으로.
(예: "김부장님이 계셨어요" → [{"name":"김부장","relation":"부장"}])
